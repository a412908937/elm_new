...
async function elmRequestByH5(cookies, api, dataStr) {
    ...
    const url = `https://guide-acs.m.taobao.com/h5/${api}/1.0/?jsv=2.7.1&appKey=12574478&t=${timestamp}&sign=${sign}&api=${api}&v=1.0&type=originaljson&dataType=json`;
    try {
